...
int main(){
    ...
    if(obj1.check(60)) cout<<"60 is in table 1"<<endl;
    else cout<<"60 is not in hashtable 1"<<endl;

    if(obj1.check(188)) cout<<"188 is in table 1"<<endl;
   ...
   HashTable obj2(37);
    ...
    if(obj1.check(60)) cout<<"60 is in table 2"<<endl;
    else cout<<"60 is not in the hashtable 2"<<endl;

    if(obj1.check(188)) cout<<"188 is in table 2"<<endl;
